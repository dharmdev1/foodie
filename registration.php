                            ...
                            <div class="widget">
                                <div class="widget-body">
                                    ...
                                    <form action="" method="post">
                                        <P><h2 style="color:blue;text-align:center;">Registration</h2></p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input class="form-control" type="text" name="phone" id="example-tel-input-3" pattern="(?:\(?\+977\)?)?[9][6-9]\d{8}|01[-]?[0-9]{7}
"required>
                                            </div>
                                            <div class="form-group col-sm-6">
